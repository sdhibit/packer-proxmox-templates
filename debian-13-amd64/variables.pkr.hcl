...
variable "template_name" {
  ...
  default     = "debian-13.6-cloudinit"
}

variable "template_description" {
  type        = string
  description = "Description of the VM template."
  default     = "Base template for Debian 13.6 (trixie)."
}
...
variable "iso_url" {
  ...
  default     = "https://cdimage.debian.org/cdimage/release/13.6.0/amd64/iso-cd/debian-13.6.0-amd64-netinst.iso"
}
...
variable "iso_checksum" {
  ...
  default     = "ce0eeee7b51fdcdbed1e5116668c1fee27e528767bdf488e5f115a67b225e5dfd0afca1d456aaa9408ceb6b8527521ff7b6b5d62fdbe6f8c5faaf8df56a96292"
}
