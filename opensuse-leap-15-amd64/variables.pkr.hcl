...
variable "template_name" {
  ...
  default     = "opensuse-leap-15-cloudinit"
}

variable "template_description" {
  type        = string
  description = "Description of the VM template."
  default     = "Base template for OpenSUSE 15."
}
...
variable "iso_url" {
  ...
  default     = "https://download.opensuse.org/distribution/leap/15.5/iso/openSUSE-Leap-15.5-NET-x86_64-Media.iso"
}
...
variable "iso_file" {
  ...
  default     = null //"openSUSE-Leap-15.5-NET-x86_64-Media.iso"
}

variable "iso_checksum" {
  type        = string
  description = "Checksum of the ISO file."
  default     = "a2f7f2f1b6b3d3ef96f5c8f804d87ebd01e5cf982357c533f4c39c33cd20ec56"
}
...
variable "language" {
  type        = string
  description = "The language set during the AutoYaST install."
  default     = "en_US"
}
...
variable "keyboard_keymap" {
  type        = string
  description = "Sets the keyboard keymap during the AutoYaST install."
  default     = "english-us"
}

variable "timezone" {
  type        = string
  description = "Sets the timezone during the AutoYaST install."
  default     = "Etc/UTC"
}
